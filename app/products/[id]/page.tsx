          ...
          <div className="flex justify-between items-start gap-5 flex-wrap pb-6">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-4">
                {amazonsChoice && (
                  <div className="w-fit p-2 rounded-md bg-gray-700">
                    <p className="text-orange-400">
                      <span className="text-white">Amazon's</span> Choice
                    </p>
                  </div>
                )}
                {(outOfStock && (
                  <p className="text-red-500 font-bold">Out of Stock</p>
                )) || <p className="text-primary-green font-bold">In Stock</p>}
              </div>
              <Link
                href={product.url}
                target="_blank"
                className="text-base text-black flex gap-2"
              >
                <p className="opacity-50">Visit Product</p>
              </Link>
            </div>
          ...
          <div className="product-info">
            ...
            <div className="flex flex-col gap-4">
              ...
              {(purchaseHistory && (
                ...
                <p className="text-sm text-black opacity-50">
                  {" "}
                  100 or less purchased in the last month
                </p>
              )}
            </div>
          </div>
